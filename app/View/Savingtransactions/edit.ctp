...
<?php echo $this->Form->create('Savingtransaction');?>
	<fieldset>
		<legend><?php echo __('Edit Savingtransaction'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Savingtransaction.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Savingtransaction.id'))); ?></li>
